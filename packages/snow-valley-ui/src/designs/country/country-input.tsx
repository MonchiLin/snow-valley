...
import { FloatingInput, SelectableInputSwitchView } from '../../base/floating-input';
import { MaterialIcons } from '@expo/vector-icons';
import type { ICountry } from './country';

export const CountryInput = (props: { country: ICountry | null; onPress?: () => void }) => {
  return (
    <TouchableOpacity onPress={props.onPress}>
      <FloatingInput label={'Country'} focused={props.country !== null}>
        ...
        <View style={{ flex: 1 }} />
        <MaterialIcons name="arrow-forward-ios" size={12} color={props.country ? '#64A0E8' : '#A8A8A8'} />
      </FloatingInput>
    </TouchableOpacity>
  );
};
